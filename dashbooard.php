...
table {
  ...
  <!-- <div class="main">
    ...
    // </div>
     ...
     <div id="ec">
         <h2 class="header"> MySql Connection  </h2>
         <?php

		$link=mysqli_connect("localhost", "root","3699","ecdb");
		...
		if($result = mysqli_query($link, "SELECT * FROM citizen "))
		{
      ...
      ?>
       ...
       <div id="registry">
		...
		<?php
		   $db = pg_connect( "host=127.0.0.1 port=5432 dbname=registrydb user=username password=password" );
		   if(!$db) {
		     echo "<script type='text/javascript'>
                    alert('Ooops! An error occured.');
                    </script>";
       ...
       <div id="nhis">
        ...
        <div id="moh">
         <h2 class="header"> MSSQL Database Connection </h2>
           
        <?php
                $myHost = "14.0.1000.169";
                $myServer = "ACER";
                $myUser = "sa";
                $myPass = "password";
                $myDB = "mohdb"; 
